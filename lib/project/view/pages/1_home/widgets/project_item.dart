...
class ProjectItemData {
  ProjectItemData({
    ...
    this.playStoreUrl = "",
    this.webUrl = "",
    this.navTitleColor = AppColor.grey600,
    this.navSelectedTitleColor = AppColor.black,
    this.appLogoColor = AppColor.black,
  });
...
class ProjectData extends StatelessWidget {
  const ProjectData({
    ...
    this.subtitleStyle,
    this.titleStyle,
    this.indicatorColor = AppColor.grey550,
...
class ProjectItemLg extends StatefulWidget {
  const ProjectItemLg({
    ...
    this.buttonTitle = AppString.VIEW,
    this.backgroundOnHoverColor = AppColor.primaryColor,
    this.backgroundColor = AppColor.accentColor2,
    this.projectNumberStyle,
    this.subtitleStyle,
    this.titleStyle,
          ...
          children: [
            ...
            Positioned(
              ...
              child: AnimatedBubbleButton(
                ...
                title: AppString.VIEW_PROJECT.toUpperCase(),
