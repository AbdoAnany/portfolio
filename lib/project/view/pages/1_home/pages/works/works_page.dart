...
import 'package:anany_me/project/view/pages/1_home/pages/works/widgets/noteworthy_projects.dart';
...
class WorksPage extends StatefulWidget {
  static const String worksPageRoute = AppString.WORKS_PAGE;
...
class _WorksPageState extends State<WorksPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      selectedPageName: AppString.WORKS,
