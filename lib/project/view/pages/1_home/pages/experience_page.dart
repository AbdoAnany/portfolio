...
import 'package:anany_me/project/view/pages/1_home/pages/widgets/animated_footer.dart';
...
class ExperiencePage extends StatefulWidget {
  static const String experiencePageRoute = AppString.EXPERIENCE_PAGE;
...
class _ExperiencePageState extends State<ExperiencePage>
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      selectedPageName: AppString.EXPERIENCE,
      ...
      child: ListView(
        ...
        children: [
          PageHeader(
            headingText: AppString.EXPERIENCE,
