...
import 'package:anany_me/project/view/pages/1_home/pages/about/widgets/about_header.dart';
import 'package:anany_me/project/view/pages/1_home/pages/about/widgets/technology_section.dart';
...
class AboutPage extends StatefulWidget {
  static const String aboutPageRoute = AppString.ABOUT_PAGE;
...
class _AboutPageState extends State<AboutPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? bodyText2Style =
        textTheme.bodyText1?.copyWith(color: AppColor.grey750);
    ...
    return PageWrapper(
      ...
      selectedPageName: AppString.ABOUT,
                ...
                children: [
                  ...
                  VisibilityDetector(
                    ...
                    child: ContentBuilder(
                      ...
                      number: "/01 ",
                      width: contentAreaWidth,
                      section: AppString.ABOUT_DEV_STORY.toUpperCase(),
                      title: AppString.ABOUT_DEV_STORY_TITLE,
                      body: Column(
                        children: [
                          AnimatedPositionedText(
                            ...
                            maxLines: 30,
                            // factor: 1.25,
                            text: AppString.ABOUT_DEV_STORY_CONTENT_1,
                          ...
                          AnimatedPositionedText(
                            ...
                            width: widthOfBody,
                            maxLines: 30,
                            text: AppString.ABOUT_DEV_STORY_CONTENT_2,
                            textStyle: bodyText1Style,
                          ),
                           AnimatedPositionedText(
                            controller: _storySectionAnimation,
                            width: widthOfBody,
                            maxLines: 30,
                            text: AppString.ABOUT_DEV_STORY_CONTENT_3,
                            textStyle: bodyText1Style,
                          ),
                        ],
                      ),
                  ...
                  VisibilityDetector(
                    ...
                    child: ContentBuilder(
                      ...
                      number: "/02 ",
                      width: contentAreaWidth,
                      section: AppString.ABOUT_DEV_TECHNOLOGY.toUpperCase(),
                      title: AppString.ABOUT_DEV_TECHNOLOGY_TITLE,
                      body: Column(
                        children: [
                          AnimatedPositionedText(
                            ...
                            width: widthOfBody,
                            maxLines: 12,
                            text: AppString.ABOUT_DEV_TECHNOLOGY_CONTENT,
                            textStyle: bodyText1Style,
                          ),
                        ],
                      ),
                  ...
                  VisibilityDetector(
                    ...
                    child: ContentBuilder(
                      ...
                      number: "/03 ",
                      width: contentAreaWidth,
                      section: AppString.ABOUT_DEV_CONTACT.toUpperCase(),
                      title: AppString.ABOUT_DEV_CONTACT_SOCIAL,
                      body: Column(
                      ...
                      footer: Column(
                        ...
                        children: [
                          ...
                          AnimatedTextSlideBoxTransition(
                            controller: _contactController,
                            text: AppString.ABOUT_DEV_CONTACT_EMAIL,
                            textStyle: titleStyle,
                          ),
                          SpaceH40(),
                          AnimatedLineThroughText(
                            text: AppString.DEV_EMAIL,
                            hasSlideBoxAnimation: true,
                            controller: _contactController,
                            onTap: () {
                              Functions.launchUrl(AppString.EMAIL_URL);
                            },
                            textStyle: bodyText2Style,
                          ),
                        ],
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: AnimatedTextSlideBoxTransition(
                            controller: _quoteController,
                            text: "— ${AppString.FAMOUS_QUOTE_AUTHOR}",
