...
import 'package:anany_me/project/view/pages/1_home/pages/home/widgets/home_page_header.dart';
import 'package:anany_me/project/view/pages/1_home/pages/home/widgets/loading_page.dart';
...
class HomePage extends StatefulWidget {
  static const String homePageRoute = AppString.HOME_PAGE;
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      selectedPageName: AppString.HOME,
      ...
      customLoadingAnimation: LoadingHomePageAnimation(
        text: AppString.DEV_NAME,
        style: textTheme.headline4!.copyWith(color: AppColor.white),
        onLoadingDone: () {
          _slideTextController.forward();
        },
      ),
        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  AnimatedTextSlideBoxTransition(
                    ...
                    text: AppString.CRAFTED_WITH_LOVE,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  AppString.THERES_MORE.toUpperCase(),
                  ...
                  child: AnimatedSlideTranstion(
                    ...
                    child: TextButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            AppString.VIEW_ALL_PROJECTS.toLowerCase(),
      ...
      items.add(
        Container(
          ...
          child: ProjectItemLg(
            ...
            backgroundColor: AppColor.accentColor2.withOpacity(0.35),
