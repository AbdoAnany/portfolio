...
import 'package:anany_me/project/view/pages/1_home/pages/widgets/page_header.dart';
...
class CertificationPage extends StatefulWidget {
  static const String certificationPageRoute = AppString.CERTIFICATION_PAGE;
...
class _CertificationPageState extends State<CertificationPage>
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      selectedPageName: AppString.CERTIFICATIONS,
      ...
      child: ListView(
        ...
        children: [
          PageHeader(
            headingText: AppString.CERTIFICATIONS,
