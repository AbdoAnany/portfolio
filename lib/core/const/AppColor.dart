...
class AppColor{
  ...
  static const Color nimbusNavTitle = AppColor.black;
  ...
  static const Color anany_me_v1 = Color(0xFF0E1319);
  static const Color anany_meV1NavTitle = Color(0xFF162726);

  static const Color anany_me_v2 = primaryColor;
  static const Color anany_meV2NavTitle = Color(0xFFF6C350);
  static const Color anany_meV2SelectedNavTitle = Color(0xFFF6C350);

  static const Color otp_package = drop;
  static const Color otpPackageNavTitle = AppColor.black;
...
//static  Future<Color> white_black(context) async =>await HomeCubit.darkThemePref.getTheme()? Colors.white : Colors.black;
}